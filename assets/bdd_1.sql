...
CREATE TABLE message(
	...
	,CONSTRAINT message_etudiant0_FK FOREIGN KEY (id_exp) REFERENCES etudiant(id_etudiant)
)ENGINE=InnoDB;
...
CREATE TABLE recevoir(
	...
	,CONSTRAINT recevoir_etudiant_FK FOREIGN KEY (id_dest) REFERENCES etudiant(id_etudiant)
